...
Auto-generated by the Hee-Lee Oss task-decomposition agent on 2026-06-29. All 27 files in `tasks/`
have been validated against `taskSchema` (AJV draft-07). The seed file `open-transliteration-provenance-001.json`
was pre-existing; 26 new files were created.

| File | Milestone | Type | Deliverable | Priority | riskTier | tokenEstimate |
|---|---|---|---|---|---|---|
| open-transliteration-provenance-001.json | M0 | data | dataset | high | low | small |
| open-transliteration-schema-001.json | M0 | code | pr | high | low | small |
| open-transliteration-license-000.json | M0 | research | document | high | low | small |
| open-transliteration-engine-001.json | M0 | code | pr | high | low | medium |
| open-transliteration-checker-001.json | M0 | code | pr | high | low | small |
| open-transliteration-harness-001.json | M0 | code | pr | high | low | medium |
| open-transliteration-scheme-cyrl-001.json | M0 | data | dataset | high | medium | medium |
| open-transliteration-vectors-cyrl-001.json | M0 | data | dataset | high | medium | small |
| open-transliteration-watcher-001.json | M0 | code | pr | high | low | small |
| open-transliteration-engine-002.json | M1 | code | pr | high | low | medium |
| open-transliteration-reviewers-001.json | M1 | writing | document | high | low | small |
| open-transliteration-reviewers-002.json | M1 | research | document | high | low | medium |
| open-transliteration-scheme-deva-001.json | M1 | data | dataset | high | medium | large |
| open-transliteration-vectors-deva-001.json | M1 | data | dataset | high | medium | medium |
| open-transliteration-license-001.json | M1 | code | pr | high | low | small |
| open-transliteration-watcher-002.json | M1 | code | pr | high | low | small |
| open-transliteration-scheme-arab-001.json | M2 | data | dataset | medium | medium | large |
| open-transliteration-vectors-arab-001.json | M2 | data | dataset | medium | medium | medium |
| open-transliteration-docs-001.json | M2 | writing | document | medium | low | small |
| open-transliteration-adopter-001.json | M3 | research | document | medium | low | medium |
| open-transliteration-contract-001.json | M3 | design-spec | document | medium | low | small |
| open-transliteration-integration-001.json | M3 | code | pr | medium | medium | medium |
| open-transliteration-scale-001.json | M4 | data | dataset | low | medium | large |
| open-transliteration-lossy-001.json | M4 | data | dataset | low | medium | medium |
| open-transliteration-rotation-001.json | M4 | maintenance | document | low | low | small |
| open-transliteration-outcomes-001.json | M4 | data | dataset | low | low | small |
| open-transliteration-maint-001.json | M4 | maintenance | document | low | low | small |

Fan-out dimensions: none (each script pair — Cyrillic, Devanagari, Arabic — was already an
explicit row in the TASKS.md backlog table; no additional fan-out applied).
...
```json
{
  ...
  "resources": [
    "C:/Users/jason/AppData/Local/Temp/claude/C--code-hee-lee-oss/5eca0d44-6b8b-4c30-9696-37a524cb249a/scratchpad/plans/open-transliteration/PLAN.md",
